...
describe('CalculateDebts', () => {
    const calculateDebts = new CalculateDebts()
    test('CalculateDebts must return an array of Debtors for a expense with n payers and 0 debtors', () => {
        const expense: Expense = {id: '1', concept: 'concept 1', payers: [payer1, payer2], debtors: []}
    ...
    test('CalculateDebts must return an array of Debtors for a expense with n payers and n debtors', () => {
        const expense: Expense = {id: '1', concept: 'concept 1', payers: [payer1, payer2], debtors: [debtor3]}
        const expected:Debtor[] = [
            {...payer1, amount: -50},
            {...payer2, amount: 0},
            {...debtor3, amount: 50},
